...
!function(e, t) {
    ...
    function d(e, t=!1, n=!1) {
        let r, i = e.querySelector(`.${s}`), a = document.createTreeWalker(e, NodeFilter.SHOW_ALL, {
            acceptNode: e=>{
                if (i && n) {
    ...
    let L = e=>new Promise((t=>{
      ...
      , M = async({index: e, queueItems: t, wait: n, cursor: r, cursorOptions: i})=>{
        let a = t[e][1]
          , o = []
          , s = e
          , l = a
    ...
    return function(e, r={}) {
        let L = async(e,t,n=!1)=>{
          ...
          , $ = ()=>(e=>b(e) ? n(e.value) : d(e, !0).filter((e=>!(e.childNodes.length > 0))))(J)
          , H = (e,t)=>(ee.add(e),
        ((e={})=>{
            let t = e.delay;
            t && ee.add({
        ...
        this.reset = function(e) {
            ...
            for (let t in K)
                K[t] = !1;
            return J[x() ? "value" : "innerHTML"] = "",
            this
        }
        ,
        this.go = function() {
            return K.started ? this : (R(),
            Y.waitUntilVisible ? (((e,t)=>{
        ...
        let te = !!Y.cursor && !x()
          , ne = (()=>{
            ...
            te ? (e.innerHTML = a(Y.cursorChar).innerHTML,
        ...
        Y.strings = (e=>{
            let t = J.innerHTML;
            return t ? (J.innerHTML = "",
            Y.startDelete ? (J.innerHTML = t,
            i(J),
            k(S({
                func: Q,
                delay: A(1),
